...
class __TwigTemplate_d548f295d9ce4d7136618afe217bbb1d extends Template
{
    private $source;
    private $macros = [];
    ...
    <a href=\"";
        // line 27
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_review_edit", ["id" => twig_get_attribute($this->env, $this->source, (isset($context["review"]) || array_key_exists("review", $context) ? $context["review"] : (function () { throw new RuntimeError('Variable "review" does not exist.', 27, $this->source); })()), "id", [], "any", false, false, false, 27)]), "html", null, true);
        echo "\">edit</a>
...
{% endblock %}
", "review/show.html.twig", "/Users/kristelocampo/Desktop/LocalGuides/templates/review/show.html.twig");
    }
}
