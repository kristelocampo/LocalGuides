...
class __TwigTemplate_1a850eb6931d1937284dde041b4e57d1 extends Template
{
    private $source;
    private $macros = [];
    ...
    <table class=\"table\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["user"]) {
            ...
            echo "\">edit</a>
                    <a href=\"";
            // line 32
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_user_delete", ["id" => twig_get_attribute($this->env, $this->source, $context["user"], "id", [], "any", false, false, false, 32)]), "html", null, true);
            echo "\">delete</a>
...
";
    ...
    {
        return array (  150 => 41,  141 => 37,  131 => 32,  127 => 31,  123 => 30,  118 => 28,  114 => 27,  110 => 26,  106 => 25,  103 => 24,  98 => 23,  81 => 9,  77 => 8,  73 => 6,  66 => 5,  53 => 3,  36 => 1,);
    }
...
{% block body %}
    <h1>User index</h1>
    <div class=\"create\">
        <a href=\"{{ path('app_register_user') }}\">Create new User</a>
        <a href=\"{{ path('app_register_guide') }}\">Create new Guide</a>
    </div>
...
{% endblock %}
", "user/index.html.twig", "/Users/kristelocampo/Desktop/LocalGuides/templates/user/index.html.twig");
    }
}
